<?php
    ...
    */
    ...
    /*
        ============================================================================================
        ** "getItems" Function v1.0 ( version 1.0 ) 
        ** Function To Get "Items" From "items table" in Database
        ============================================================================================
    */
    function getItems($where , $value , $approve=NULL)
    {
        // make "DB Connection variable" global to access it from anywhere
        global $con;
        // Get "All Items" With "Approve = 1" only [ Approved Items ]
    ...
    */
    ...
    /*
        ============================================================================================
        ** "checkUserRegStatus" Function v1.0 ( version 1.0 ) 
        ** Function To Check The "RegStatus" of User in Database[ if "RegStatus"== 0 or "RegStatus"== 1 ]
            To Specify if "user is Active" or "Not"
        ** Function Parameters:
            1- $user  = The Username
        ============================================================================================
    */
    function checkUserRegStatus($user)
    {
        // make "DB Connection variable" global to access it from anywhere
        global $con;
        // "Query" To Select "Username" and "RegStatus"
